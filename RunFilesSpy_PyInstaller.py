...
if mode == '1':
    ...
    if current_system == 'Windows':
        subprocess.Popen([python_path, py_file], stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE, creationflags=subprocess.DETACHED_PROCESS | subprocess.CREATE_NEW_PROCESS_GROUP)
        ...
        subprocess.Popen([python_path, py_file], stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE, preexec_fn=os.setpgrp)
    else:
        print("不支持的操作系统。")
else:
